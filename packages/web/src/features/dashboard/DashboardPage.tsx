...
import { useHomes } from '../homes/useHomes'
...
import { Home, ClipboardList, Wallet, BarChart3, LogOut, Settings, Calendar, BellRing, Check } from 'lucide-react'
...
type Tab = 'home' | 'tasks' | 'finance' | 'more'
...
export function DashboardPage() {
  ...
  const tabs: { key: Tab; label: string; icon: ReactNode }[] = [
    { key: 'home', label: 'Resumen', icon: <Home className="h-4 w-4" /> },
    { key: 'tasks', label: 'Actividades', icon: <ClipboardList className="h-4 w-4" /> },
